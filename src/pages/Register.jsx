        ...
        <div className="flex flex-col items-center md:mt-50 md:mb-5">
            <div className="bg-stone-700 w-150 rounded-xl pb-5">
                ...
                <form action="" className="flex flex-col items-center">
                    <input type="text" className="border-2 border-stone-700 w-100 h-10 rounded-full m-2 p-5 bg-white" placeholder="Enter username" />
                    ...
                    <input type="text" className="border-2 border-stone-700 w-100 h-10 rounded-full m-2 p-5 bg-white" placeholder="Re-enter password" />
