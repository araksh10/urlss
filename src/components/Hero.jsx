...
const Hero = () => {
    ...
    <div className="select-none">
            <div className="relative mt-5 ">
                ...
                <div className="">
                    <div className="absolute hidden md:block bg-stone-800 h-100 w-100 top-50 -right-75 rounded-full">
                        <div className="absolute h-[50%] w-[50%] bg-orange-400 opacity-50 z-10 top-0 rounded-full"></div>
                    </div>
                </div>
            </div>
        </div>
